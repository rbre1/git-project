...
def get_filters():
    ...
    """
    print('Hello! welcome to US bikeshare data!\n')
    print('Here you can explore the US bikeshare data for 3 cities. Chicago, New York City and Washington')
    ...
    while True:
        ...
        if city in CITY_DATA:
            ...
            print("Invalid input. Please choose valid city and try again")
    ...
    while True:
        ...
        if month in months:
            ...
            print("Invalid input. Please enter a valid month or 'all' and try again")
    ...
    while True:
        ...
        if day in days:
            ...
            print("Invalid input. Please enter a valid day or 'all' and try again")
